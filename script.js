...
var editButton = "<button onclick=\"editData(this)\">Edit</button>";
var deleteButton = "<button onclick=\"deleteData(this)\">Delete</button>";
var TableData = [];
var Editing = null;
...
function loadOptions() {
    ...
    for (var x in Districts) {
        citySelect === null || citySelect === void 0 ? void 0 : citySelect.appendChild(createOption(x));
    }
    for (var _i = 0, States_1 = States; _i < States_1.length; _i++) {
        var x = States_1[_i];
        stateSelect === null || stateSelect === void 0 ? void 0 : stateSelect.appendChild(createOption(x));
    }
}
function updateState() {
    var stateSelect = document.getElementById("state");
    var citySelect = document.getElementById("city");
    var state = Districts[citySelect.value];
...
function addData() {
    // Get Form Data
    var sno = TableData.length + 1;
    var name = getInputId("name");
    var age = getInputId("age");
    var city = getInputId("city");
    var state = getInputId("state");
    ...
    var nameData = name === null || name === void 0 ? void 0 : name.value;
    var ageData = age === null || age === void 0 ? void 0 : age.value;
    var cityData = city === null || city === void 0 ? void 0 : city.value;
    var stateData = state === null || state === void 0 ? void 0 : state.value;
...
function updateData() {
    // Get Form Data
    var row = Editing;
    var serial = row.cells[0].innerHTML - 1;
    var name = getInputId("name");
    var age = getInputId("age");
    var city = getInputId("city");
    var state = getInputId("state");
...
function editData(button) {
    ...
    // Get row data values
    var sno = row.cells[0].innerHTML - 1;
    var name = TableData[sno].name;
    var age = TableData[sno].age;
    var city = TableData[sno].city;
    var state = TableData[sno].state;
    // Set Data in Form
...
function deleteData(button) {
    ...
    for (var i = 1; i < totalRows - 1; ++i) {
        var cell = table.rows[i].cells[0].innerHTML;
        if (cell != i) {
